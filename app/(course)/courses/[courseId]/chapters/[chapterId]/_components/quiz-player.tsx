        ...
        <>
          ...
          >
              ...
              {quizConfig.isGraded ? (
                <>
                  <p className="flex justify-between">
                    ...
                    <strong
                      className={cn('text-lg', passed ? 'text-emerald-600' : 'text-rose-600')}
                    >
                      {latestAttempt.score}%
                    </strong>
                  </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
              ...
              {quizConfig.allowSubmissionReportView && (
                <Button variant="outline" onClick={() => setReviewAttemptId(latestAttempt.id)}>
      ...
      <>
        ...
        >
          ...
          <div className="mt-6 flex justify-center gap-3">
            ...
            {quizConfig.allowSubmissionReportView && (
              <Button variant="outline" onClick={() => setReviewAttemptId(session.id)}>
                View Submission Report
              </Button>
            )}
          </div>
