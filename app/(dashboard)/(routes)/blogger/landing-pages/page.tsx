...
const BloggerLandingPagesPage = async () => {
  ...
  return (
    <div className="p-6">
      ...
      <LandingPagesClient data={pages} newPath="/blogger/landing-pages/new" isAdmin={false} />
    </div>
  );
};

export default BloggerLandingPagesPage;
