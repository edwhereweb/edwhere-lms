      ...
      <div className="grid grid-cols-1 gap-4">
        <BannerCard
          ...
          description={`This is where you can see your progress 
            and continue your courses. This is a demonstration LMS and as such, all courses are free and Razorpay is in test
             mode. To enroll in a course, use test credentials in the Razorpay payment modal. Contact me from
