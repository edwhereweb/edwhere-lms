...
- Upload thumbnails, attachments, and videos using Cloudflare R2
...
Cloudflare R2 https://developers.cloudflare.com/r2/ for file upload storage (S3-compatible, presigned URLs).
